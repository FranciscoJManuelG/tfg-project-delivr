...
import * as actionsShopping from '../../shopping/actions';
import {Errors} from '../../common';


const PayPalOrder = ({totalPrice, cart, companyId, street, cp, codeDiscount}) => {
            ...
            transactions: [
                {
                    ...
                    description: 'Pedido realizado en Relivry'
                }
            ],
        };
