...
public class UserServiceImpl implements UserService {
	...
	@Override
	public void payWeeklyBalanceToCompanies(Long userId) throws InstanceNotFoundException, PermissionException {
	...
	@Override
	public User payQuarterlyFee(Long userId) throws InstanceNotFoundException {
		User user = permissionChecker.checkUser(userId);
